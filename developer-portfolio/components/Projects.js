						...
						<Accordion className="accordion">
							...
							<AccordionDetails className="accordionDetails">
								<Typography className="projectDetails">
									...
									<br />
									<h6 className="aboutHeading">About</h6>
									An application for a medical centre that allows a user
									(patient) to view the doctor's appointments for the next 2
									weeks as well as find contact information to call for a
									booking. A signed in admin user (receptionist or doctor) can
									view all of the doctor's appointments, create a new
									appointment, edit an existing appointment and delete an
									appointment.
									<br />
									<br />
									<a
										href="https://github.com/ChadProbert/dr-smith-medical-centre-app"
										target="_blank"
										rel="noopener noreferrer"
									>
										<Button variant="contained" className="githubButton">
									...
									<a
										href="https://dr-smith-medical-centre.herokuapp.com/"
										target="_blank"
										rel="noopener noreferrer"
									>
										<Button variant="contained" className="websiteButton">
						...
						<Accordion className="accordion">
							...
							<AccordionDetails className="accordionDetails">
								<Typography className="projectDetails">
									...
									adjacent mines are displayed. The user can flag a tile if they
